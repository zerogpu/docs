...
- [Data extraction](/cookbook/data-extraction): structured fields, NER, and PII from text
- [Tutorial: Resume & profile extraction](/cookbook/data-extraction-tutorial): dataset, blog, batch script
