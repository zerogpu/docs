...
The response body includes the model output in the structure returned by the [Responses API](/api-reference/endpoint/responses). Extract the summary text from the response and handle errors (e.g. 4xx/5xx) and rate limits in your code.
