...
1. **`redact-pii`** (`gliner2.5-multi-v1`) masks the personal data before anything else touches the text:
...
3. **`classify-structured`** (`gliner2.5-base-v1`) tags it against your label schema:
