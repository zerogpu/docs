...
<Note>
All sample people and companies in the [example dataset](https://github.com/zerogpu/cookbook/tree/main/demos/data-extraction/dataset) are **synthetic and fictional**.
</Note>
