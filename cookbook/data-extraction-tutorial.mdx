...
This tutorial walks through **three production-style use cases** for structured data extraction with the [gliner2.5-base-v1](/api-reference/models/gliner2-5-base-v1) model. You will use plain text only (resumes, LinkedIn-style exports, job posts). **Not** OCR or PDF parsing.
...
**Model (steps 1-3):** `gliner2.5-base-v1`  
...
Before storing user-submitted resumes, run PII extraction with the [gliner2.5-multi-v1](/api-reference/models/gliner2-5-multi-v1) model and `extract-pii` or `redact`.
...
<CardGroup cols={2}>
	<Card
		title="gliner2.5-base-v1 model"
		icon="book"
		href="/api-reference/models/gliner2-5-base-v1"
	>
