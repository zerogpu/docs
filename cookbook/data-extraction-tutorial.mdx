...
GitHub: [zerogpu/docs/tutorials/data-extraction](https://github.com/zerogpu/docs/tree/main/tutorials/data-extraction) (see the [README](https://github.com/zerogpu/docs/blob/main/tutorials/data-extraction/README.md) for setup).
...
<CardGroup cols={2}>
  ...
  <Card title="Companion article" icon="newspaper" href="https://github.com/zerogpu/docs/blob/main/tutorials/data-extraction/blog-post.md">
