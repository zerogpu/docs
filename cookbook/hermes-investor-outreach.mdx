...
The one-liner matters more than anything else in the file. It is the string the ranking step scores every investor's thesis against, so a vague sentence produces a vague shortlist.
...
mcp__zerogpu__zerogpu_classify_zero_shot → ranked 11 candidates against the one-liner
...
Per-model subtotal
  ...
  deberta-v3-small         3 calls    $0.00047
