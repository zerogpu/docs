...
<CardGroup cols={2}>
    ...
    <Card title="Raise a seed round with Hermes Agent" icon="rocket" href="/cookbook/hermes-investor-outreach">
        Research investors, rank them against your pitch, and land five personalized Gmail drafts for under half a cent.
    </Card>
    <Card title="Summarize your inbox with OpenClaw" icon="file-text" href="/cookbook/openclaw-inbox-summarizer">
        Forward messy messages to your OpenClaw assistant and get back a PII-safe summary with topic and urgency labels.
    </Card>
</CardGroup>
