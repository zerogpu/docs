...
<CardGroup cols={2}>
    ...
    <Card title="Clean CRM notes with the OpenClaw plugin" icon="file-text" href="/cookbook/openclaw-crm-note-workflow">
        From one prompt, the OpenClaw agent redacts PII, extracts fields as JSON, classifies the deal stage, and summarizes, all via the local zerogpu CLI.
    </Card>
</CardGroup>
