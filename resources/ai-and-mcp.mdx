...
<Tabs>
  ...
  <Tab title="Cursor">
    ...
    <Accordion title="One-click install from the docs (if available)">
      Some docs themes show an AI or connect icon on the docs site. If you see it on [ZeroGPU docs](https://docs.zerogpu.ai), you can connect to Cursor from there without editing `mcp.json`. Use that path if your theme supports it.
    </Accordion>
  </Tab>
</Tabs>
...
| URL | Use |
|-----|-----|
| `https://docs.zerogpu.ai/llms.txt` | Sitemap-style index of pages and descriptions |
| `https://docs.zerogpu.ai/llms-full.txt` | Full documentation in one Markdown file |
