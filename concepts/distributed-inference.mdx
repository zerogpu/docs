...
<Frame caption="ZeroGPU distributed inference architecture">
  <img src="/assets/images/diagram.png" alt="ZeroGPU distributed inference architecture showing Your App connecting to the ZeroGPU Router, which distributes requests to Edge Devices running NLMs with Cloud Fallback" />
</Frame>
