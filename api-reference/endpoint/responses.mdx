...
Send input to an AI model and receive a generated response. In the **API playground** below, change **model** to load that model's sample request body automatically, then send with your `x-api-key` and `x-project-id`.
