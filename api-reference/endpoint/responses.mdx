...
openapi: "openapi/zerogpu.openapi.yaml POST /responses"
---

Send input to an AI model and receive a generated response. Use the **API playground** below to send a live request with your `x-api-key` and `x-project-id`.
