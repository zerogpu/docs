---
title: "Responses (ZeroClick)"
description: "OpenAI-style Responses inference authenticated by a ZeroClick HMAC signature instead of an API key."
sidebarTitle: "Responses"
openapi: "api-reference/openapi/zeroclick.openapi.json POST /zeroclick/v1/responses"
---
