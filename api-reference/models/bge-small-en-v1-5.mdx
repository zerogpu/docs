...
sidebarTitle: "bge-small-en-v1.5"
...
Embeddings are priced on input tokens only. There are no output tokens to bill, so a call costs $0.004 per 1M tokens embedded.
