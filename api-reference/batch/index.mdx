...
<CardGroup cols={2}>
  ...
  <Card title="Supported endpoint" href="/api-reference/batch/supported-endpoints">
    Only <code>/v1/chat/completions</code> is batchable. Body and response shape.
  </Card>
  <Card title="Examples" href="/api-reference/batch/examples">
    End-to-end walkthroughs in <code>curl</code> and the Python <code>openai</code> SDK.
  </Card>
</CardGroup>
