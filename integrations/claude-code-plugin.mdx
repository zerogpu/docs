...
**`Request failed with status 429`** - you're being rate-limited. Back off and retry with exponential delay, or switch heavy workloads to the [Batch API](/api-reference/batch/index), which has separate quotas tuned for bulk jobs.
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="code" href="/api-reference/endpoint/responses">
