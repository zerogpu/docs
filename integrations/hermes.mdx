...
|---|---|---|---|---|
| `deepseek-v4.1-flash` | 1,048,576 | $0.14 | $0.57 | Default. Agentic work with tool calling. |
| `glm-5.2` | 262,144 | $1.10 | $3.50 | Hardest reasoning, long multi-step plans. |
...
**Hermes rejects the model at startup.** The context window is under 64,000 tokens. Use `deepseek-v4.1-flash`, `glm-5.2`, or `gpt-oss-120b`, and set `context_length` explicitly if auto-detection fails.
