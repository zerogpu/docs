...
hermes config set providers.ZeroGPU.default_model 'deepseek-v4-flash-0731'
...
|---|---|---|---|---|
| `deepseek-v4-flash-0731` | 1,048,576 | $0.16 | $0.38 | Default. Agentic work with tool calling. |
...
**Hermes rejects the model at startup.** The context window is under 64,000 tokens. Use `deepseek-v4-flash-0731`, `glm-5.2`, or `gpt-oss-120b`, and set `context_length` explicitly if auto-detection fails.
