...
model: gliner2.5-multi-v1 · 2 spans masked
```
...
model: gliner2.5-multi-v1 · 5 spans masked
```
...
| `classify-structured`   | Multi-axis schema classification             | `gliner2.5-base-v1`                   | auto       |
| `extract-entities`      | Custom-label named-entity recognition        | `gliner2.5-base-v1`                   | auto       |
| `extract-json`          | Pull structured fields into grouped JSON     | `gliner2.5-base-v1`                   | auto       |
| `extract-pii`           | Extract PII grouped by category              | `gliner2.5-multi-v1`               | auto       |
| `redact-pii`            | Mask PII in-line with `[LABEL]` placeholders | `gliner2.5-multi-v1`               | auto       |
