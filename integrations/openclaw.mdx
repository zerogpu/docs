...
<Note>
	Looking for worked examples in the meantime? Browse the [cookbook
	index](/cookbook/index) for end-to-end walkthroughs of classification,
	extraction, and PII workflows on ZeroGPU's small models.
</Note>
...
| `classify-iab-enriched` | IAB categories plus topics, keywords, intent | `zlm-v1-iab-classify-edge-enriched` | auto       |
