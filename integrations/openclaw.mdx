...
<Note>
	For more worked examples, browse the [cookbook index](/cookbook/index) for end-to-end walkthroughs of classification, extraction, and PII workflows on ZeroGPU's small models.
</Note>
