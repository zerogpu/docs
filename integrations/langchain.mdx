...
- **Model:** `gliner2.5-multi-v1` (with `mask: "label"`)
...
| `ZeroGPUClassifyIABEnrichedTool` | `zerogpu_classify_iab_enriched` | `zlm-v2-iab-classify-edge-enriched` | IAB + topics / keywords / intent | JSON |
| `ZeroGPUClassifyZeroShotTool` | `zerogpu_classify_zero_shot` | `deberta-v3-small` | Zero-shot vs. custom labels | JSON |
| `ZeroGPUClassifyStructuredTool` | `zerogpu_classify_structured` | `gliner2.5-base-v1` | Multi-axis schema classification | JSON |
| `ZeroGPUExtractEntitiesTool` | `zerogpu_extract_entities` | `gliner2.5-base-v1` | Custom-label NER | JSON |
| `ZeroGPUExtractPIITool` | `zerogpu_extract_pii` | `gliner2.5-multi-v1` | Extract PII entities | JSON |
| `ZeroGPURedactPIITool` | `zerogpu_redact_pii` | `gliner2.5-multi-v1` (mask: label) | Mask PII inline with `[LABEL]` | `str` |
| `ZeroGPUExtractJSONTool` | `zerogpu_extract_json` | `gliner2.5-base-v1` | Schema-driven JSON extraction | JSON |
