...
| <a href="/api-reference/models/zlm-v1-multi-iab-classify" style={{display:"inline-flex",alignItems:"center",gap:"0.5rem",textDecoration:"none",color:"inherit",wordBreak:"break-word",borderBottom:"none"}}><img src="https://models-favicon.zerogpu.ai/zlm-v1-iab-classify-edge-enriched/logo_dark.png" alt="zlm-v1-multi-iab-classify" width="22" height="22" noZoom /> <code>zlm-v1-multi-iab-classify</code></a> | $0.05 | $0.40 | — | Text Classification | 400 |
| <a href="/api-reference/models/all-minilm-l6-v2" style={{display:"inline-flex",alignItems:"center",gap:"0.5rem",textDecoration:"none",color:"inherit",wordBreak:"break-word",borderBottom:"none"}}><img src="https://models-favicon.zerogpu.ai/all-minilm-l6-v2/all-minilm-l6-v2.png" alt="all-minilm-l6-v2" width="22" height="22" noZoom /> <code>all-minilm-l6-v2</code></a> | $0.50 | Not billed | — | Text Embedding | 256 |
| <a href="/api-reference/models/bge-small-en-v1-5" style={{display:"inline-flex",alignItems:"center",gap:"0.5rem",textDecoration:"none",color:"inherit",wordBreak:"break-word",borderBottom:"none"}}><code>bge-small-en-v1.5</code></a> | $0.50 | Not billed | — | Text Embedding | 512 |
...
<CardGroup cols={2}>
  ...
  <Card href="/api-reference/models/zlm-v1-moderation-edge">
    ...
    <div style={{marginTop:"0.45rem"}}><span style={{display:"inline-block",borderRadius:"9999px",border:"1px solid rgba(128,128,128,0.3)",background:"rgba(128,128,128,0.12)",padding:"1px 9px",fontSize:"12px",fontWeight:500,marginRight:"6px",marginBottom:"6px"}}>4,000 max tokens</span><span style={{display:"inline-block",borderRadius:"9999px",border:"1px solid rgba(128,128,128,0.3)",background:"rgba(128,128,128,0.12)",padding:"1px 9px",fontSize:"12px",fontWeight:500,marginRight:"6px",marginBottom:"6px"}}>\$0.02 / 1M input</span><span style={{display:"inline-block",borderRadius:"9999px",border:"1px solid rgba(128,128,128,0.3)",background:"rgba(128,128,128,0.12)",padding:"1px 9px",fontSize:"12px",fontWeight:500,marginRight:"6px",marginBottom:"6px"}}>\$0.05 / 1M output</span></div>
  ...
  <Card href="/api-reference/models/zlm-v1-multi-iab-classify">
    <div style={{display:"flex",alignItems:"center",gap:"0.65rem",marginTop:"-0.25rem"}}>
      <img src="https://models-favicon.zerogpu.ai/zlm-v1-iab-classify-edge-enriched/logo_dark.png" alt="zlm-v1-multi-iab-classify" width="32" height="32" noZoom style={{flexShrink:0,borderRadius:"7px",margin:"1rem 0"}} />
      <div style={{fontWeight:600,fontSize:"1.1rem",lineHeight:"1.3"}}>zlm-v1-multi-iab-classify</div>
    </div>

    <div style={{marginTop:"0.45rem"}}><span style={{display:"inline-block",borderRadius:"9999px",border:"1px solid rgba(128,128,128,0.3)",background:"rgba(128,128,128,0.12)",padding:"1px 9px",fontSize:"12px",fontWeight:500,marginRight:"6px",marginBottom:"6px"}}>400 max tokens</span><span style={{display:"inline-block",borderRadius:"9999px",border:"1px solid rgba(128,128,128,0.3)",background:"rgba(128,128,128,0.12)",padding:"1px 9px",fontSize:"12px",fontWeight:500,marginRight:"6px",marginBottom:"6px"}}>\$0.05 / 1M input</span><span style={{display:"inline-block",borderRadius:"9999px",border:"1px solid rgba(128,128,128,0.3)",background:"rgba(128,128,128,0.12)",padding:"1px 9px",fontSize:"12px",fontWeight:500,marginRight:"6px",marginBottom:"6px"}}>\$0.40 / 1M output</span></div>

    The multilingual variant of ZeroGPU's IAB classifier returns the same full content-intelligence profile as the enriched edge model, for text that is not in English. One call gives you IAB categories across both taxonomies…
  </Card>
  <Card href="/api-reference/models/all-minilm-l6-v2">
    ...
    <div style={{marginTop:"0.45rem"}}><span style={{display:"inline-block",borderRadius:"9999px",border:"1px solid rgba(128,128,128,0.3)",background:"rgba(128,128,128,0.12)",padding:"1px 9px",fontSize:"12px",fontWeight:500,marginRight:"6px",marginBottom:"6px"}}>256 max tokens</span><span style={{display:"inline-block",borderRadius:"9999px",border:"1px solid rgba(128,128,128,0.3)",background:"rgba(128,128,128,0.12)",padding:"1px 9px",fontSize:"12px",fontWeight:500,marginRight:"6px",marginBottom:"6px"}}>\$0.50 / 1M input</span></div>
...
<CardGroup cols={2}>
  ...
  <Card title="Text Classification" icon="tags" href="/docs/text-classification">
    5 models: `zlm-v2-iab-classify-edge-enriched`, `zlm-v1-iab-classify-edge`, `zlm-v1-iab-domain-classifier`, `deberta-v3-small`, `zlm-v1-multi-iab-classify`
  </Card>
  ...
  <Card title="Ad Tech" icon="bullhorn" href="/docs/ad-tech">
    4 models: `zlm-v1-iab-classify-edge`, `zlm-v2-iab-classify-edge-enriched`, `zlm-v1-iab-domain-classifier`, `zlm-v1-multi-iab-classify`
  </Card>
</CardGroup>
