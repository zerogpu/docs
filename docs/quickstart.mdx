...
First API call in minutes. Three things from your dashboard, one API call, done.
...
If you get a `401`, your API key is wrong. A `403` means a bad project ID - see [Authentication](/platform/authentication).
