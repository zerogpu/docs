...
| <a href="/api-reference/models/zlm-v1-multi-iab-classify" style={{display:"inline-flex",alignItems:"center",gap:"0.5rem",textDecoration:"none",color:"inherit",wordBreak:"break-word",borderBottom:"none"}}><img src="https://models-favicon.zerogpu.ai/zlm-v1-iab-classify-edge-enriched/logo_dark.png" alt="zlm-v1-multi-iab-classify" width="22" height="22" noZoom /> <code>zlm-v1-multi-iab-classify</code></a> | $0.05 | $0.40 | 400 |
