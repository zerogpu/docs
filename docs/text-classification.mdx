...
| <a href="/api-reference/models/zlm-v1-multi-iab-classify" style={{display:"inline-flex",alignItems:"center",gap:"0.5rem",textDecoration:"none",color:"inherit",wordBreak:"break-word",borderBottom:"none"}}><img src="https://models-favicon.zerogpu.ai/zlm-v1-iab-classify-edge-enriched/logo_dark.png" alt="zlm-v1-multi-iab-classify" width="22" height="22" noZoom /> <code>zlm-v1-multi-iab-classify</code></a> | $0.05 | $0.40 | 90M | 400 |
...
Reach for [zlm-v2-iab-classify-edge-enriched](/api-reference/models/zlm-v2-iab-classify-edge-enriched) when the text is English. Supports batch processing through the [Batch API](/docs/batch/index).
...
curl https://api.zerogpu.ai/v1/chat/completions \
  ...
  "messages": [
    {
      "role": "user",
      "content": "¿Cuáles son los conceptos básicos del ejercicio y la aptitud física? El ejercicio regular es una de las mejores cosas que puede hacer por su salud."
    }
  ]
}'
```
...
The result arrives as a JSON string in the output text. Parsed, and trimmed here to the first entries of each list:
