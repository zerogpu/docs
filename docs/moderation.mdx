...
| --- | ---: | ---: | ---: |
| <a href="/api-reference/models/zlm-v1-moderation-edge" style={{display:"inline-flex",alignItems:"center",gap:"0.5rem",textDecoration:"none",color:"inherit",wordBreak:"break-word",borderBottom:"none"}}><img src="https://models-favicon.zerogpu.ai/zlm-v1-iab-classify-edge-enriched/logo_dark.png" alt="zlm-v1-moderation-edge" width="22" height="22" noZoom /> <code>zlm-v1-moderation-edge</code></a> | $0.10 | $0.15 | 800 |
