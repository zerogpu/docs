...
| <a href="/api-reference/models/glm-5-2" style={{display:"inline-flex",alignItems:"center",gap:"0.5rem",textDecoration:"none",color:"inherit",wordBreak:"break-word",borderBottom:"none"}}><img src="https://models-favicon.zerogpu.ai/z.ai/z.jpeg" alt="glm-5.2" width="22" height="22" noZoom /> <code>glm-5.2</code></a> | $1.12 | $3.51 | 753B | 1,048,576 |
