...
| <a href="/api-reference/models/t5-small" style={{display:"inline-flex",alignItems:"center",gap:"0.5rem",textDecoration:"none",color:"inherit",wordBreak:"break-word",borderBottom:"none"}}><img src="https://models-favicon.zerogpu.ai/t5-small/icons8-google-logo-96.png" alt="t5-small" width="22" height="22" noZoom /> <code>t5-small</code></a> | $0.05 | $0.40 | 60M | 512 |
...
**References:** [Model card](https://huggingface.co/google-t5/t5-small) • [Terms](https://zerogpu.ai/terms) • [Privacy](https://zerogpu.ai/privacy-policy)

Inputs are truncated at 512 tokens, so chunk anything longer, or use `llama-3.1-8b-instruct-fast` when the whole document has to land in one pass. Summaries are extractive in style: T5 compresses the source sentences rather than rewriting them.
...
```text Response
artemis III mission is scheduled for late 2026. astronauts will descend to the moon using spaceX starship as a lunar lander.
```
